package by.safronenko.contactmanager.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "by.safronenko.contactmanager.reposiroty",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "by.safronenko.contactmanager.model" });
